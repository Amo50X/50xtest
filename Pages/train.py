...
def CreateData(path):
    ...
    while True:
        ...
        suc, frame = cap.read()
        image_placeholder.image(caption="Take images", image=frame, channels='BGR')
        if btn_Capture:
